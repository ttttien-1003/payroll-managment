...
public:
     ...
     */
    void calculateAllWelfareForEmployee(const IEmployee& employee, const AttendanceManager& attendanceManager, int month, int year, double& outBonuses, double& outAllowances, double& outDeductions) const;
};
