 ...
 * @brief Khai báo lớp TransportationWelfare kế thừa từ IWelfare.
 *
 * Lớp này đại diện cho phúc lợi Phụ cấp đi lại.
 */
...
private:
    ...
    double ratePerKm;       ///< Số tiền phụ cấp cho mỗi km di chuyển (được lấy theo thời giá, tại 18/05: 4000đ/km)
...
public:
    ...
    /**
     * @brief Destructor cho TransportationWelfare.
     */
    ~TransportationWelfare() override = default;
};
